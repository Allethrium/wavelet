...
// =====================================================================
// DEMO MODE
// While the line below is present, every control write (buttons,
// dropdowns, toggles, group/host changes) reports success back to the
// UI but never contacts etcd, and never touches any real hardware.
//
// To switch this copy over to real, live control: delete (or comment
// out) the "define('DEMO_MODE', true);" line below and restart the web
...
$etcd_ch = DEMO_MODE ? null : setCurl();
...
$token          = DEMO_MODE ? null : get_etcd_auth_token();
