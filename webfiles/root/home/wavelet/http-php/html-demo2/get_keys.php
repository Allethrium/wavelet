...
// =====================================================================
// DEMO MODE
// While the line below is present, this endpoint returns the static
// mock data in demo_mock_data.json and never contacts etcd or any real
// hardware.
//
// To switch this copy over to real, live data: delete (or comment out)
// the "define('DEMO_MODE', true);" line below and restart the web
...
if (DEMO_MODE) {
	readfile(__DIR__ . '/demo_mock_data.json');
	exit;
}
