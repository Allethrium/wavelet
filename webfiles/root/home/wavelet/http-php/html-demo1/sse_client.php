...
// =====================================================================
// DEMO MODE
// While the line below is present, this endpoint only sends periodic
// heartbeats and never connects to Redis or streams live etcd changes.
// The mock UI updates its own state locally when buttons are clicked,
// so no live push channel is needed.
//
// To switch this copy over to the real, live event stream: delete (or
// comment out) the "define('DEMO_MODE', true);" line below and restart
// the web server (php-fpm/nginx).
// =====================================================================
