...
event_x265sw() {
        ...
        KEYNAME=uv_encoder
        KEYVALUE="libavcodec:encoder=libx265:preset=ultrafast:tune=zerolatency:crf=30:threads=0:gop=10"
        ...
        KEYVALUE="25M"
        write_etcd_global
        echo -e "libx265 Software acceleration activated (compatibility mode), GOP 30 frames,  CRF 30 \n"
}
